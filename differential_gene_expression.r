...
sorted_q_values %>% arrange(padj)->orderd_values
...
downregulated_gene %>% arrange(desc(log2FoldChange))->top_downregulated_gene
top_n(top_downregulated_gene, 20, log2FoldChange)->twenty_gene

#creating csv file
write.table(twenty_gene, file="top_twenty_downregulated_gene.csv")
...
#creating csv file
write.table(twenty_topgene, file="top_twenty_upregulated_gene.csv")
